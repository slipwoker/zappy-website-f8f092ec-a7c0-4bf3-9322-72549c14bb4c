document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            requiredFields.forEach(field => {
                ...
                if (!value) {
                    ...
                    showError(field, field.getAttribute('data-error-minlength') || 'Message must be at least 10 characters');
                    isValid = false;
                }
            });
                ...
                if (submitButton) {
                    ...
                    .then(response => {
                        if (response.ok) {
                            ...
                            successMessage.textContent = contactForm.getAttribute('data-success') || 'Message sent successfully!';
                    ...
                    .catch(() => {
                        ...
                        errorMessage.textContent = contactForm.getAttribute('data-error') || 'Something went wrong. Please try again.';
        ...
        contactForm.addEventListener('blur', function(e) {
            ...
            if (!field.hasAttribute('required') && !field.type === 'email' && !field.type === 'tel') return;
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'f8f092ec-a7c0-4bf3-9322-72549c14bb4c',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'f8f092ec-a7c0-4bf3-9322-72549c14bb4c';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'f8f092ec-a7c0-4bf3-9322-72549c14bb4c';
